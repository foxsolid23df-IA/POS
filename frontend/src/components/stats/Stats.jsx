    ...
    useEffect(() => {
        ...
        const cargarDatosIniciales = async () => {
            try {
                ...
                if (isMounted) {
                    setErrorStats('No se pudieron cargar las estadísticas. Por favor, recarga la página.')
                    mostrarModal(
                ...
                <div className="max-w-full mx-auto w-full mb-10">
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl flex flex-wrap items-end gap-6 shadow-sm">
                        <div className="flex-1 min-w-[400px]">
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mb-3 ml-1">Análisis por Período</p>
                            <DateFilter
