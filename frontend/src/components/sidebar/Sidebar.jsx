    ...
    <>
      ...
      >
        ...
        <div className="p-6 border-b border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-3 font-bold text-xl tracking-tight dark:text-white">
            ...
            <div className="flex flex-col">
              <span className="leading-none text-primary dark:text-white">
                NEXUM POS
              </span>
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto custom-scrollbar">
          ...
          {!webAdminMode && !isVisorMode && canAccessReports && (
            <NavLink
              to="/gastos"
              className={({ isActive }) => `
                            flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all duration-200
          ...
          {isAdmin && (
            ...
            >
              ...
              <span className="text-sm font-bold">Modo Inventario</span>
            </NavLink>
          )}
              ...
              {!webAdminMode && (isAdmin || activeStaff?.permissions?.reset_cash) && (
                <button
                  onClick={() => {
                    if (
                      window.confirm(
                        "¿Estás seguro de desvincular esta PC? Deberás configurar la caja de nuevo al iniciar sesión.",
                      )
                    ) {
